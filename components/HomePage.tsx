...
const ServiceHighlightCard: React.FC<{ icon: React.ReactElement; title: string; description: string; to: string; }> = ({ icon, title, description, to }) => (
    <div className="bg-gray-50 p-8 rounded-lg transition-all duration-300 hover:bg-white hover:shadow-xl flex flex-col">
        ...
        <div className="flex-grow flex items-end">
            <Link to={to} className="mt-4 font-semibold text-brand-blue hover:text-blue-700 transition-colors">
                Learn More &rarr;
            </Link>
        </div>
    </div>
...
const TestimonialCard: React.FC<{ quote: string; name: string; title: string; imageUrl: string; }> = ({ quote, name, title, imageUrl }) => (
    <div className="bg-white p-8 rounded-xl shadow-lg text-center">
        ...
        <div className="mt-6 flex items-center justify-center">
            <img className="h-14 w-14 rounded-full object-cover" src={imageUrl} alt={`Testimonial from ${name}, ${title}`} />
    ...
    return (
        <div className="animate-fadeIn">
            ...
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-brand-black">Why Partner with CloudAdept?</h2>
                        <p className="mt-2 text-lg text-gray-600">We provide the ServiceNow expertise to elevate your business operations.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <FeatureCard 
                            icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l9-5-9-5-9 5 9 5z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l6.16-3.422A12.083 12.083 0 0121 12c0 6.627-5.373 12-12 12S-3 18.627-3 12c0-1.206.18-2.362.518-3.422L12 14z" /></svg>}
            ...
            <section className="py-20 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-brand-black">Our Core ServiceNow Services</h2>
                        <p className="mt-2 text-lg text-gray-600">Tailored solutions for your digital transformation on the Now Platform.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-brand-black">Get In Touch</h2>
                        ...
                        <div className="bg-gray-50 p-8 rounded-lg shadow-sm">
                            {status === 'submitted' ? (
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="mt-4 text-2xl font-semibold text-brand-black">Thank You!</h3>
                                    <p className="mt-2 text-gray-600">Your message has been sent. We'll get back to you shortly.</p>
                                </div>
                            ) : (
                                <form onSubmit={handleFormSubmit} className="space-y-6">
                                    <div>
                                        <label htmlFor="home-name" className="block text-sm font-medium text-gray-700">Full Name</label>
                                        <input type="text" name="name" id="home-name" required className="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-brand-blue focus:border-brand-blue" />
                                    </div>
                                    <div>
                                        <label htmlFor="home-email" className="block text-sm font-medium text-gray-700">Email Address</label>
                                        <input type="email" name="email" id="home-email" required className="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-brand-blue focus:border-brand-blue" />
                                    </div>
                                    <div>
                                        <label htmlFor="home-message" className="block text-sm font-medium text-gray-700">Message</label>
                                        <textarea id="home-message" name="message" rows={4} required className="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-brand-blue focus:border-brand-blue"></textarea>
                                    </div>
                                    <div>
                                        <button
                                            type="submit"
                        ...
                        <div className="space-y-8 pt-4">
                            <div>
                                <h3 className="text-lg font-semibold text-brand-black flex items-center">
                                    <svg className="h-6 w-6 text-brand-blue mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                                    Our Office
                                </h3>
                                <p className="mt-1 text-gray-600">123 Cloud Way, Suite 500<br/>Tech City, TX 75001</p>
                            </div>
                            <div>
                                <h3 className="text-lg font-semibold text-brand-black flex items-center">
                                    <svg className="h-6 w-6 text-brand-blue mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                    Email Us
                                </h3>
